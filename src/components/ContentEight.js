...
const ContentEight = () => {
    return (
        <div className="content-eight">
            ...
            <div className="content-eight-info">
                Если Вас волнует то, как станут добираться будущие клиенты
                до пункта назначения, можете быть спокойны: в ближайшее время
                будет запущен общественный транспорт и обустроены автобусные остановки.
            </div>
